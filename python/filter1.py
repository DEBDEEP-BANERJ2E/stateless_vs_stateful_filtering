...
if __name__ == "__main__":
    ...
    stateful_thread = threading.Thread(target=run_stateful_traffic, args=(benchmark, 500, 0.01))
    stateless_thread = threading.Thread(target=run_stateless_traffic, args=(benchmark, 500, 0.01))

    # Start both threads
    stateful_thread.start()
    stateless_thread.start()

    # Wait for both threads to complete
    stateful_thread.join()
    stateless_thread.join()
